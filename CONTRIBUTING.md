...
The `main` branch holds the library and demo source. Update `demo` from a tested main commit to publish a new playground through GitHub Pages. `npm run capture:demo` records the running demo into `docs/assets` for the README.
